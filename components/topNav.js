...
export default function TopNav({ showModButtons, onAddBook, onSubmitBook, onSearch }) {
        ...
        <div className={`${styles.headerWrap}`}>
            <AnimateSharedLayout>
                <div className={styles.buttonWrap}>
                    ...
                    <FooterButton text="Add Book" onClick={onAddBook} />
                    <FooterButton text="Submit Book" href={onSubmitBook} />
                </div>
            </AnimateSharedLayout>
        </div>
    );
